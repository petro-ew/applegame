//
// Created by petroew on 04.12.23.
//

#ifndef APPLEGAME_CHECKBOX_H
#define APPLEGAME_CHECKBOX_H
...
public:
    CheckBox(sf::RectangleShape GUI_COLOR, std::string CHECKBOX_TEXT, sf::Color TEXT_COLOR)
    {
        ...
        checkBox_Background.setFillColor(sf::Color(GUI_COLOR.getFillColor().r - 40.0f,
                                                   GUI_COLOR.getFillColor().g - 40.0f,
                                                   GUI_COLOR.getFillColor().b - 40.0f));
        themeColor = sf::Color(GUI_COLOR.getFillColor().r - 40, GUI_COLOR.getFillColor().g - 40,
                               GUI_COLOR.getFillColor().b - 40);
    ...
    void updateCheckBox(int slot, sf::RectangleShape GUI_BACKGROUND, sf::RenderWindow& window)
    {
        ...
        CHECKBOX_POSITION = sf::Vector2f(GUI_BACKGROUND.getGlobalBounds().left + 10.0f,
                                         GUI_BACKGROUND.getGlobalBounds().top + slot * 20.0f);
